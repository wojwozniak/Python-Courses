...
def calculate_demographic_data(print_data=True):
    ...
    percetages_highest_earning_countries = (df[df['salary'] == '>50K']['native-country'].value_counts(
    ) / df['native-country'].value_counts() * 100).sort_values(ascending=False)

    highest_earning_country = percetages_highest_earning_countries.index[0]
    highest_earning_country_percentage = round(
        percetages_highest_earning_countries.iloc[0], 1)
